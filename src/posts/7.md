...
gluetun_cobalt_api:
  ...
  environment:
    ...
    - VPN_TYPE=wireguard
    - WIREGUARD_ENDPOINT_IP=162.159.192.1 # this IP is the A record of engage.cloudflareclient.com, if it changes ever just update it
...
Change your image from `ghcr.io/imputnet/cobalt` to `git.canine.tools/canine.tools/cobalt:api`. This image is a fork of cobalt to make changes to allow YouTube (and other services) to work.
